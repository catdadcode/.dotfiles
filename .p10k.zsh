# Generated by Powerlevel10k configuration wizard on 2023-08-22 at 15:29 MDT.
...
# 2 lines, dotted, full frame, dark-ornaments, sparse, many icons, concise,
...
() {
  ...
  function prompt_catdadcode() {
	  p10k segment -f "#0f0" -i '🐱🧔💻'
  }
