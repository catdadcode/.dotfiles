...
${PR_GREEN}${PR_ULCORNER}${PR_HBAR}${PR_GREEN}(\
${PR_MAGENTA}%${PR_PWDLEN}<...<%~%<<\
${PR_GREEN})${PR_GREEN}${PR_HBAR}${PR_GREEN}[$(git_prompt_info)$(git_prompt_status)${PR_GREEN}]${PR_NO_COLOUR}\

${PR_GREEN}${PR_LLCORNER}${PR_GREEN}${PR_HBAR}\
🐱👨💻${PR_HBAR}${PR_GREEN}➤${PR_NO_COLOUR} '

PS2='${PR_CYAN}${PR_HBAR}\
${PR_CYAN}${PR_HBAR}(\
${PR_LIGHT_GREEN}%_${PR_GREEN})${PR_HBAR}\
